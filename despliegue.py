...
def despliegue(result1, clave, saldos, n_cuenta, code_giro, valor_giro, password):#USA LAS VARIABLES Y LISTAS DEL MAIN
    while True:
        ...
        if result2 == 1:
          ...
          if r_retiro >= 10:
            ...
            if r_retiro % 10 == 0:
              ...
              if p4ss in clave:
                if r_retiro <= saldos[clave.index(p4ss)]:
                  print('  RETIRO EXITOSO')
                  saldos[clave.index(p4ss)]-= r_retiro 
        ...
        if employee_pass in password:
          ...
          for item in valor_giro:
            if item > 0:
              ...
              print(f'  Fondo: {valor_giro[valor_giro.index(value)]:,}$')
              print('  -------------------------------------')
